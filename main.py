...
# Advanced Functional Feature Engineering
# 1. Outliers
# 2. Missing Values
...
df['League_N'] = df['League_N'].astype(int)
df['Division_W'] = df['Division_W'].astype(int)
df['NewLeague_N'] = df['NewLeague_N'].astype(int)
...
target_corr_df = target_correlation_summary(df, "Salary", num_cols)
